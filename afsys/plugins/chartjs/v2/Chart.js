...
module.exports = function(Chart) {
	...
	Chart.controllers.polarArea = Chart.DatasetController.extend({
		...
		updateElement: function(arc, index, reset) {
			...
			var ance = arc.hidden ? 0 : scale.getDistanceFromCenterForValue(dataset.data[index]);
...
module.exports = function(Chart) {
	 ...
	 * @param anceMetric {Function} Optional function to provide the ance between
	 * @return {ChartElement[]} the nearest items
	 */
	function getNearestItems(chart, position, intersect, anceMetric) {
		...
		if (!anceMetric) {
			anceMetric = helpers.anceBetweenPoints;
		}
	...
	function indexMode(chart, e, options) {
		...
		var anceMetric = function(pt1, pt2) {
		...
		inRange: function(chartX, chartY) {
			...
			if (vm) {
				var pointRelativePosition = helpers.getAngleFromPoint(vm, {
					...
					ance = pointRelativePosition.ance;
				...
				var betweenAngles = (angle >= startAngle && angle <= endAngle),
					withinRadius = (ance >= vm.innerRadius && ance <= vm.outerRadius);
